...
<div className="flex md:px-36 flex-col md:flex-row justify-center items-center w-full h-full mt-8 md:mt-5">
    ...
    <img src={o} className="w-65 h-80 md:w-[57vw] md:h-[80vh]"  style={{borderRadius:"40px" }} alt="Description" />
